...
require('./utils/validateEnv').validateEnv('web-admin');
...
app.use(session({
  key: sessionKey, // Same cookie name as main app
  secret: process.env.SESSION_SECRET, // Same secret as main app (validated at startup)
  store: sessionStore,
  resave: false,

...
| **erlandrid** | Спонсор и контрибьютор · идеи, улучшения, новое для проекта |
| **map788** | Контрибьютор · идеи, поиск багов и недоработок |
| **avtnmvis** | Контрибьютор · идеи, поиск багов и недоработок |
...
Также благодарим **map788** и **avtnmvis** — за идеи, внимательный поиск багов и недоработок.

Полный список спонсоров, донатеров и тех, кому мы говорим спасибо — в **[CONTRIBUTORS.md](CONTRIBUTORS.md)**.

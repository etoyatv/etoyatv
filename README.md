...
2. [Команда](#команда)
3. [Сделано с участием ИИ](#сделано-с-участием-ии)
4. [Карта сервисов: что поднимать](#карта-сервисов-что-поднимать)
5. [Архитектура простыми словами](#архитектура-простыми-словами)
6. [Что нужно установить заранее](#что-нужно-установить-заранее)
7. [Пошаговый запуск для новичка](#пошаговый-запуск-для-новичка)
8. [Проверка: что всё ожило](#проверка-что-всё-ожило)
9. [Первый пользователь и админка](#первый-пользователь-и-админка)
10. [Канал и первая трансляция (OBS)](#канал-и-первая-трансляция-obs)
11. [Переменные окружения (подробно)](#переменные-окружения-подробно)
12. [Медиа, CDN и samples](#медиа-cdn-и-samples)
13. [Weblate и переводы UI](#weblate-и-переводы-ui)
14. [LibreTranslate / машинный перевод UGC](#libretranslate--машинный-перевод-ugc)
15. [Выход в интернет (Nginx + HTTPS)](#выход-в-интернет-nginx--https)
16. [Студия в браузере (WHIP)](#студия-в-браузере-whip)
17. [Подводные камни](#подводные-камни)
18. [Частые ошибки и что делать](#частые-ошибки-и-что-делать)
19. [Остановка и обновление](#остановка-и-обновление)
20. [Карта файлов и папок (что где править)](#карта-файлов-и-папок-что-где-править)
21. [Ссылки](#ссылки)
...
| Участник | Роль |
|----------|------|
| **ki4arl** | Сооснователь; вайб-кодер / программист |
| **rotama** | Сооснователь; сетевой и системный инжиниринг |
| **ConnectMe** | Сооснователь; привлечение аудитории и развитие комьюнити |
| **motionarium** | Вайб-кодер (второй) |
| **eweka** | В планах — мобильная разработка *(пока не случилось)* |

Спонсоры и донатеры, которым мы обещали отдельную страницу благодарности: **[CONTRIBUTORS.md](CONTRIBUTORS.md)**.
